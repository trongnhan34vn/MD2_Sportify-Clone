      ...
      <div>
        ...
        <div className='home-page mb-[66px] flex'>
          ...
          <div className='content'>
            {/* Nav */}
            <div className='fixed z-50 right-0 left-[241px] navbar-menu h-16 px-8 flex justify-between'>
              ...
              <div className='nav-list flex items-center gap-4'>
                <ul className='text-[#fff] flex gap-4 font-CircularBook'>
                  ...
                  <li className='inline-block'>
                    <a href='' className='h-8 items-center justify-between gap-2 flex rounded-[500px] text-sm inline-block py-[3px] leading-6 hover:opacity-100 transition-all duration-200'>
                      <span className=''>
          ...
          <footer className='fixed z-10 bottom-0 right-0 left-0'>
            ...
            <div className='flex gap justify-between items-center bg-[#181818] h-[90px] justify-between pt-[11px] pr-[24px] pb-[7px] pl-[15px] '>
              <div className='footer-content song-info flex items-center'>
                ...
                <div className='song-name mx-[14px] pl-[6px] pr-3'>
                  <a className='font-CircularLight hover:underline cursor-pointer block leading-6 text-sm text-[#fff]'>Anh đâu phải anh hùng</a>
              ...
              <div className='song-control flex flex-col'>
                <div className='song-control-btn flex gap-4'>
                  ...
                  <button className='w-8 h-8 flex justify-center items-center bg-[#fff] rounded-[50%] hover:scale-105'>
                    <svg
                      role="img"
                      height="16"
                      width="16"
                ...
                <div className='song-run flex gap-2 items-center max-w-3xl'>
                  <p className='font-CircularLight text-[11px] text-[#B3B3B3]'>0:06</p>
                  <div className='w-full h-3 relative'>
                    <div className='absolute top-[50%] translate-y-[-50%] w-full h-1 rounded bg-[hsla(0,0%,100%,.3)]'></div>
                  </div>
                  <p className='font-CircularLight text-[11px] text-[#B3B3B3]'>4:42</p>
                </div>
              </div>
              <div className=''>
