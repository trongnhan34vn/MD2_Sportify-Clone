...
export default function DirectionMenu() {
    ...
    let adminPermission = currentUser?.user?.permission
    const elementAdmin = (adminPermission ==="admin") ? "Quản lí danh sách" : "Tìm kiếm"
    return (
        <div>
            {/* Direction Menu */}
            <div id='direction-menu' className='h-auto pt-6 w-[241px] bg-[#000] fixed z-10 bottom-0 top-0'>
                {/* Logo */}
                <Link to={"/"} className='direction-menu-logo block mb-7 px-6'>
                    <svg
                        role="img"
                        viewBox="0 0 78 24"
                        height="100%"
                ...
                <ul className='dircet-menu-list text-[#fff] mb-7 px-2'>
                    <Link to={'/'} className='px-4 flex opacity-75 transition-all duration-200 gap-4 items-center hover:opacity-100'>
                        <svg
                            role="img"
                            height="24"
                            width="24"
                    ...
                    <Link to={(adminPermission ==="admin") ? "/admin" : "/"} className='px-4 flex opacity-75 transition-all duration-200 gap-4 items-center hover:opacity-100'>
                        <svg
                            role="img"
                            height="24"
                            width="24"
                        ...
                        <span className='font-CircularMedium text-sm leading-10'>{elementAdmin}</span>
                    </Link>
