        ...
        <div>
            ...
            <div id='login'>
                ...
                <header className='border-b-[1px] border-solid border-[#d9dadc] mb-8'>
                    <div className='header-logo inline-block pt-8 mb-4'>
                        <svg
                            role="img"
                            viewBox="0 0 78 24"
                            height="100%"
                            className="header-logo-img w-[186px] h-[56px]"
                        >
                ...
                {/* Header */}
                {/* Login */}
                <section className='font-CircularMedium login-wrap max-w-md mx-auto'>
                    {/* Login With */}
                    <div className="font-CircularBold login-with flex flex-col gap-2.5">
                        <p className='text-sm'>To continue, log in to Spotify</p>
                        <button className='border border-[#878787] rounded-[500px] uppercase tracking-widest text-sm bg-[#1877f2] text-[#fff] py-[13px] flex justify-center items-center'>
                            <i className="fa-brands fa-square-facebook mr-2.5 text-lg"></i>
                            <span className=''>Continue With Facbook</span>
                        </button>
                        <button className='border border-[#878787] rounded-[500px] uppercase tracking-widest text-sm bg-[#000] text-[#fff] py-[13px] flex justify-center items-center'>
                            <i className="fa-brands fa-apple mr-2.5 text-lg "></i>
                            <span className=''>Continue With Apple</span>
                        </button>
                        <button className='border border-[#878787] leading-7 rounded-[500px] uppercase tracking-widest text-sm py-[13px] flex justify-center items-center'>
                            <img className='w-5 h-5 mr-2.5' src="https://cdn-icons-png.flaticon.com/512/2991/2991148.png" alt="" />
                            <span className=''>Continue With Google</span>
                        </button>
                        <button className='border border-[#878787] leading-7 rounded-[500px] uppercase tracking-widest text-sm py-[13px] flex justify-center items-center'>
                            <span className=''>Continue With Phone Number</span>
                        </button>
                        <div className='flex items-center justify-between'>
                            <hr className='w-5/12 mb-5 mt-3' /><span className='text-sm'>OR</span> <hr className='w-5/12 mb-5 mt-3' />
                        </div>
                    </div>
                    {/* Login With */}
                    {/* Login Form */}
