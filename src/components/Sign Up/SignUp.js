        ...
        <div>
            ...
            <div id='sign-up' className='max-w-md mx-auto pt-10 font-CircularMedium'>
                ...
                <header className='header'>
                    ...
                    <div className='px-7'>
                        <button className='py-[6px] px-6 rounded-[500px] text-base hover:scale-105 bg-[#405A93] text-[#fff] flex justify-center w-full mb-5 items-center'>
                            <i className="fa-brands fa-square-facebook mr-2.5 text-lg leading-9"></i>
                            <span className='leading-9'>Đăng kí bằng Facbook</span>
                        </button>
                        <button className='py-[6px] px-6 border-[2px] border-[#000] rounded-[500px] hover:scale-105 login-btn flex justify-center w-full mb-5 items-center'>
